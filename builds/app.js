(() => {
      ...
      (function() {
        ...
        var runInContext = function runInContext2(context) {
          ...
          function isIterateeCall(value, index, object) {
            ...
            if (type2 == "number" ? isArrayLike(object) && isIndex2(index, object.length) : type2 == "string" && index in object) {
          ...
          var wrapperAt = flatRest(function(paths) {
            ...
            if (length > 1 || this.__actions__.length || !(value instanceof LazyWrapper) || !isIndex2(start4)) {
  ...
  function getFocusableEdges(el) {
    ...
    const last2 = first ? findFocusableElement(el, false) || first : null;
    return [first, last2];
  }
  ...
  var A11yDialog = class {
     ...
     */
    on(type2, handler, options) {
      this.$el.addEventListener(type2, handler, options);
      return this;
    }
    /**
     * Unregister an existing callback for the given event type
     */
    off(type2, handler, options) {
      this.$el.removeEventListener(type2, handler, options);
      return this;
    }
    /**
     ...
     */
    fire(type2, event) {
      this.$el.dispatchEvent(new CustomEvent(type2, {
        detail: event,
        cancelable: true
      }));
    }
  ...
  // node_modules/@wix/image-kit/dist/esm/helpers/imageServiceFeatureSupportObject.js
  ...
  // node_modules/@wix/image-kit/dist/esm/helpers/populateFeatureSupport.js
  ...
  // node_modules/@wix/image-kit/dist/esm/helpers/utils.js
  ...
  var POSITION_TO_ALIGN_TYPE = Object.entries(ALIGN_TYPE_TO_POSITION).reduce((acc, [align, position]) => {
    acc[position] = align;
    return acc;
  }, {});
  var TILE_FITTING_TYPES = [
    fittingTypes.TILE,
  ...
  var es_default2 = __assign2(__assign2({}, legacy_default), {
    getStatusCode,
    getStatusText
  });
  ...
  function typeToConverterSet(converterSets) {
    return converterSets.reduce(function(result, converterSet) {
      var types2 = converterSet.types.reduce(function(typeResult, type2) {
        var _a14;
        return __assign3(__assign3({}, typeResult), (_a14 = {}, _a14[type2] = converterSet, _a14));
      }, {});
      return __assign3(__assign3({}, result), types2);
    }, {});
  }
  ...
  var image = (_a7 = {
    ...
    transform: function(val) {
      ...
      if (protocol === WIX_PROTOCOL) {
        ...
        return __assign5(__assign5({}, res), { altText: decodedFilenameOrAltText, filename: decodedFilenameOrAltText });
      }
      return { url: val };
    }
  }, _a7);
  ...
  var videoV2 = (_a9 = {
    ...
    transform: function(val) {
      ...
      if (protocol === WIX_PROTOCOL) {
        var res = { id };
        if (fileName) {
          res = __assign6(__assign6({}, res), { filename: decodeText(fileName) });
        }
        if (!posterUri) {
          return res;
        }
        return __assign6(__assign6({}, res), { posters: [
          {
  ...
  __export(iam_authentication_v1_authentication_public_exports, {
    ...
    login: () => login3,
    loginV2: () => loginV23,
    loginWithIdpConnectionTokens: () => loginWithIdpConnectionTokens3,
    logout: () => logout3,
  ...
  var _commonListValue = { value: "_commonCustomValue" };
  var _commonMapValue = { value: "Map#_commonCustomValue" };
  ...
  var _loginV2Request = {};
  var _loginWithIdpConnectionTokensRequest = {};
  var _logoutRequest = {};
  ...
  var _signOnRequest = { profile: "_identityProfile" };
  var _signOnResponse = {};
  ...
  function changePassword(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer2(_changePasswordRequest, {});
    const { fromJSON: fromRes } = serializer2(_changePasswordRequest, {});
  ...
  function loginWithIdpConnectionTokens(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer2(_loginWithIdpConnectionTokensRequest, {});
    const { fromJSON: fromRes } = serializer2(_stateMachineResponse, {
      _commonCustomValue,
      _commonListValue,
      _commonMapValue,
  ...
  function signOn(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer2(_signOnRequest, {
      _customField,
      _customValue,
      _identityProfile,
      _listValue,
    ...
    const { fromJSON: fromRes } = serializer2(_signOnResponse, {});
  ...
  var _addressWrapper = { address: "wix.common.Address" };
  var _changePasswordRequest2 = {};
  var _commonCustomValue2 = {
    listValue: "_commonListValue",
    mapValue: "_commonMapValue"
  };
  var _commonListValue2 = { value: "_commonCustomValue" };
  var _commonMapValue2 = { value: "Map#_commonCustomValue" };
  ...
  var _loginWithIdpConnectionTokensRequest2 = {};
  var _logoutRequest2 = {};
  ...
  var _signOnRequest2 = { profile: "_identityProfile" };
  var _signOnResponse2 = {};
  var _stateMachineResponse2 = {
    identity: "_identity",
    additionalData: "Map#_commonCustomValue"
  };
  ...
  function registerV22(loginId, options) {
    ...
    return __awaiter3(this, arguments, void 0, function* () {
      ...
      const { fromJSON } = serializer({
        ...
        depSchemas: {
          _addressWrapper,
          _commonCustomValue: _commonCustomValue2,
          _commonListValue: _commonListValue2,
          _commonMapValue: _commonMapValue2,
          _customField: _customField2,
          _customValue: _customValue2,
          _identity: _identity2,
          _identityProfile: _identityProfile2,
  ...
  function changePassword2(newPassword) {
    var _a14, _b, _c;
    return __awaiter3(this, arguments, void 0, function* () {
      ...
      const { httpClient, sideEffects } = arguments[1];
      const { toAmbassadorRequest } = serializer({
        rootSchema: _changePasswordRequest2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _fromVeloEntity2
      ...
      __log2(`"ChangePassword" sending request with: ${__inspect2(reqOpts)}`);
      (_a14 = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSiteCall) === null || _a14 === void 0 ? void 0 : _a14.call(sideEffects);
      try {
        const result = yield httpClient.request(reqOpts);
        (_b = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSuccess) === null || _b === void 0 ? void 0 : _b.call(sideEffects, result);
  ...
  function loginWithIdpConnectionTokens2(options) {
    var _a14, _b, _c;
    return __awaiter3(this, arguments, void 0, function* () {
      const requestTransformation = {
      ...
      const { httpClient, sideEffects } = arguments[1];
      const { toAmbassadorRequest } = serializer({
        rootSchema: _loginWithIdpConnectionTokensRequest2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _fromVeloEntity2
      ...
      const payload = toAmbassadorRequest([options]);
      const reqOpts = loginWithIdpConnectionTokens(payload);
      __log2(`"LoginWithIdpConnectionTokens" sending request with: ${__inspect2(reqOpts)}`);
      (_a14 = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSiteCall) === null || _a14 === void 0 ? void 0 : _a14.call(sideEffects);
      try {
        const result = yield httpClient.request(reqOpts);
        (_b = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSuccess) === null || _b === void 0 ? void 0 : _b.call(sideEffects, result);
  ...
  function signOn2(loginId, options) {
    var _a14, _b, _c;
    return __awaiter3(this, arguments, void 0, function* () {
      const requestTransformation = {
        loginId: "$[0]",
      ...
      __log2(`"SignOn" sending request with: ${__inspect2(reqOpts)}`);
      (_a14 = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSiteCall) === null || _a14 === void 0 ? void 0 : _a14.call(sideEffects);
      try {
        const result = yield httpClient.request(reqOpts);
        (_b = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSuccess) === null || _b === void 0 ? void 0 : _b.call(sideEffects, result);
  ...
  function loginWithIdpConnectionTokens3(httpClient) {
    return (options) => loginWithIdpConnectionTokens2(
      options,
      // @ts-ignore
      { httpClient }
    );
  ...
  __export(iam_recovery_v1_recovery_public_exports, {
    ...
    recover: () => recover3,
    sendActivationEmail: () => sendActivationEmail3,
    sendRecoveryEmail: () => sendRecoveryEmail3
  });

  // node_modules/@wix/identity/build/es/src/iam-recovery-v1-recovery.http.js
  var _commonCustomValue3 = {
    numValue: "DOUBLE",
    dateValue: "google.protobuf.Timestamp",
    listValue: "_commonListValue",
    mapValue: "_commonMapValue"
  };
  var _commonListValue3 = { value: "_commonCustomValue" };
  var _commonMapValue3 = { value: "Map#_commonCustomValue" };
  ...
  var _recoverRequest = {};
  var _sendActivationEmailRequest = {};
  var _sendActivationEmailResponse = {};
  var _sendRecoveryEmailRequest = {};
  var _sendRecoveryEmailResponse = {};
  var _stateMachineResponse3 = {
    identity: "_identity",
    additionalData: "Map#_commonCustomValue"
  };
  ...
  function sendActivationEmail(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer2(_sendActivationEmailRequest, {});
    const { fromJSON: fromRes } = serializer2(_sendActivationEmailResponse, {});
  ...
  function recover(payload) {
    ...
    const { fromJSON: fromRes } = serializer2(_stateMachineResponse3, {
      _commonCustomValue: _commonCustomValue3,
      _commonListValue: _commonListValue3,
      _commonMapValue: _commonMapValue3,
  ...
  var _addressWrapper2 = { address: "wix.common.Address" };
  var _commonCustomValue4 = {
    listValue: "_commonListValue",
    mapValue: "_commonMapValue"
  };
  var _commonListValue4 = { value: "_commonCustomValue" };
  var _commonMapValue4 = { value: "Map#_commonCustomValue" };
  ...
  var _sendActivationEmailRequest2 = {};
  var _sendActivationEmailResponse2 = {};
  var _sendRecoveryEmailRequest2 = {};
  var _sendRecoveryEmailResponse2 = {};
  var _stateMachineResponse4 = {
    identity: "_identity",
    additionalData: "Map#_commonCustomValue"
  };
  ...
  function sendActivationEmail2(identityId, options) {
    var _a14, _b, _c;
    return __awaiter4(this, arguments, void 0, function* () {
      const requestTransformation = {
        identityId: "$[0]",
      ...
      const { httpClient, sideEffects } = arguments[2];
      const { toAmbassadorRequest } = serializer({
        rootSchema: _sendActivationEmailRequest2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _fromVeloEntity3
      ...
      const { fromJSON } = serializer({
        rootSchema: _sendActivationEmailResponse2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _toVeloEntity3
      ...
      __log3(`"SendActivationEmail" sending request with: ${__inspect3(reqOpts)}`);
      (_a14 = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSiteCall) === null || _a14 === void 0 ? void 0 : _a14.call(sideEffects);
      try {
        const result = yield httpClient.request(reqOpts);
        (_b = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSuccess) === null || _b === void 0 ? void 0 : _b.call(sideEffects, result);
  ...
  function recover2(recoveryToken, options) {
    ...
    return __awaiter4(this, arguments, void 0, function* () {
      ...
      const { fromJSON } = serializer({
        ...
        depSchemas: {
          _addressWrapper: _addressWrapper2,
          _commonCustomValue: _commonCustomValue4,
          _commonListValue: _commonListValue4,
          _commonMapValue: _commonMapValue4,
  ...
  var _commonCustomValue5 = {
    numValue: "DOUBLE",
    dateValue: "google.protobuf.Timestamp",
    listValue: "_commonListValue",
    mapValue: "_commonMapValue"
  };
  var _commonListValue5 = { value: "_commonCustomValue" };
  var _commonMapValue5 = { value: "Map#_commonCustomValue" };
  ...
  function verifyDuringAuthentication(payload) {
    ...
    const { fromJSON: fromRes } = serializer2(_stateMachineResponse5, {
      _commonCustomValue: _commonCustomValue5,
      _commonListValue: _commonListValue5,
      _commonMapValue: _commonMapValue5,
  ...
  var _addressWrapper3 = { address: "wix.common.Address" };
  var _commonCustomValue6 = {
    listValue: "_commonListValue",
    mapValue: "_commonMapValue"
  };
  var _commonListValue6 = { value: "_commonCustomValue" };
  var _commonMapValue6 = { value: "Map#_commonCustomValue" };
  ...
  function verifyDuringAuthentication2(code, options) {
    ...
    return __awaiter5(this, arguments, void 0, function* () {
      ...
      const { fromJSON } = serializer({
        ...
        depSchemas: {
          _addressWrapper: _addressWrapper3,
          _commonCustomValue: _commonCustomValue6,
          _commonListValue: _commonListValue6,
          _commonMapValue: _commonMapValue6,
  ...
  function biHeaderGenerator(apiMetadata, publicMetadata) {
    ...
    return {
      [WixBIHeaderName]: objectToKeyValue({
        environment: "js-sdk",
        "package-name": (_a14 = apiMetadata.packageName) != null ? _a14 : publicMetadata == null ? void 0 : publicMetadata.PACKAGE_NAME,
  ...
  function objectToKeyValue(input) {
    return Object.entries(input).filter(([_3, value]) => Boolean(value)).map(([key, value]) => `${key}=${value}`).join(",");
  }
  function buildRESTDescriptor(origFunc, publicMetadata, boundFetch) {
    return origFunc({
      request: async (factory) => {
        ...
        if (request.method === "GET" && ((_a14 = request.fallback) == null ? void 0 : _a14.length) && request.params.toString().length > 4e3) {
  ...
  var moduleWithTokens = { redirects: headless_v1_redirect_session_public_exports, authentication: iam_authentication_v1_authentication_public_exports, recovery: iam_recovery_v1_recovery_public_exports, verification: iam_verification_v1_start_response_public_exports };
  function OAuthStrategy(config) {
    ...
    const getAuthHeaders = async () => {
      var _a14;
      if (!((_a14 = _tokens.accessToken) == null ? void 0 : _a14.value) || isTokenExpired(_tokens.accessToken)) {
    ...
    const generateVisitorTokens = async (tokens) => {
      var _a14, _b, _c;
      if (((_a14 = tokens == null ? void 0 : tokens.accessToken) == null ? void 0 : _a14.value) && ((_b = tokens == null ? void 0 : tokens.refreshToken) == null ? void 0 : _b.value) && !isTokenExpired(tokens.accessToken)) {
        return tokens;
      }
    ...
    const getAuthorizationUrlWithOptions = async (oauthData, responseMode, prompt, sessionToken) => {
      const { redirectSession } = await wixClientWithTokens.redirects.createRedirectSession({
        auth: {
          ...
          prompt: headless_v1_redirect_session_public_exports.Prompt[prompt]
        }
      });
    ...
    const getAuthUrl = async (oauthData, opts = {
      ...
      return getAuthorizationUrlWithOptions(
        oauthData,
        (_a14 = opts.responseMode) != null ? _a14 : "fragment",
        ...
        const res = await wixClientWithTokens.authentication.registerV2(
          ...
          },
          {
            ...
            ...params.captchaTokens && {
              captchaTokens: [
                {
                  Recaptcha: (_a14 = params.captchaTokens) == null ? void 0 : _a14.recaptchaToken,
    ...
    const processVerification = async (nextInputs, state) => {
      ...
      if (stateToUse.loginState === "EMAIL_VERIFICATION_REQUIRED") {
        const code = (_a14 = nextInputs.verificationCode) != null ? _a14 : nextInputs.code;
    ...
    const getMemberTokensForDirectLogin = async (sessionToken) => {
      ...
      return iframePromise.then((res) => {
        ...
        if (document.body.contains(iframeEl)) {
          (_a14 = iframeEl.parentElement) == null ? void 0 : _a14.removeChild(iframeEl);
        }
      });
    };
    ...
    const loggedIn = () => {
      return _tokens.refreshToken.role === "member";
    };
    return {
  ...
  var SortOrder;
  (function(SortOrder4) {
    SortOrder4[SortOrder4["ASC"] = 0] = "ASC";
    SortOrder4[SortOrder4["DESC"] = 1] = "DESC";
  })(SortOrder || (SortOrder = {}));
  ...
  // node_modules/@wix/media/build/es/src/media-site-media-v1-file-descriptor.public.js
  var media_site_media_v1_file_descriptor_public_exports = {};
  __export(media_site_media_v1_file_descriptor_public_exports, {
    MediaType: () => MediaType,
    ...
    bulkDeleteFiles: () => bulkDeleteFiles3,
    bulkImportFiles: () => bulkImportFiles3,
    bulkRestoreFilesFromTrashBin: () => bulkRestoreFilesFromTrashBin3,
    generateFileDownloadUrl: () => generateFileDownloadUrl3,
    generateFileResumableUploadUrl: () => generateFileResumableUploadUrl3,
    generateFileUploadUrl: () => generateFileUploadUrl3,
    generateFilesDownloadUrl: () => generateFilesDownloadUrl3,
    generateVideoStreamingUrl: () => generateVideoStreamingUrl3,
    getFileDescriptor: () => getFileDescriptor3,
    getFileDescriptors: () => getFileDescriptors3,
    importFile: () => importFile3,
    listDeletedFiles: () => listDeletedFiles3,
    listFiles: () => listFiles3,
    searchFiles: () => searchFiles3,
    updateFileDescriptor: () => updateFileDescriptor3
  });

  // node_modules/@wix/media/build/es/src/media-site-media-v1-file-descriptor.http.js
  var _archive = { urlExpirationDate: "google.protobuf.Timestamp" };
  var _audio = { urlExpirationDate: "google.protobuf.Timestamp" };
  var _audioV2 = { assets: "_audio" };
  var _bulkDeleteFilesRequest = {};
  var _bulkDeleteFilesResponse = {};
  var _bulkImportFilesRequest = { importFileRequests: "_importFileRequest" };
  var _bulkImportFilesResponse = { files: "_fileDescriptor" };
  var _bulkRestoreFilesFromTrashBinRequest = {};
  var _bulkRestoreFilesFromTrashBinResponse = {};
  var _document = { urlExpirationDate: "google.protobuf.Timestamp" };
  var _faceRecognition = { confidence: "DOUBLE" };
  var _fileDescriptor = {
    createdDate: "google.protobuf.Timestamp",
    updatedDate: "google.protobuf.Timestamp",
    media: "_fileMedia"
  ...
  var _generateFileDownloadUrlRequest = {};
  var _generateFileDownloadUrlResponse = {};
  var _generateFileResumableUploadUrlRequest = {};
  var _generateFileResumableUploadUrlResponse = {};
  var _generateFilesDownloadUrlRequest = {};
  var _generateFilesDownloadUrlResponse = {};
  var _generateFileUploadUrlRequest = {};
  var _generateFileUploadUrlResponse = {};
  var _generateVideoStreamingUrlRequest = {};
  var _generateVideoStreamingUrlResponse = {};
  var _getFileDescriptorRequest = {};
  var _getFileDescriptorResponse = { file: "_fileDescriptor" };
  var _getFileDescriptorsRequest = {};
  var _getFileDescriptorsResponse = { files: "_fileDescriptor" };
  ...
  var _importFileRequest = {};
  var _importFileResponse = { file: "_fileDescriptor" };
  var _listDeletedFilesRequest = {};
  var _listDeletedFilesResponse = { files: "_fileDescriptor" };
  var _listFilesRequest = {};
  var _listFilesResponse = { files: "_fileDescriptor" };
  var _model3D = {
    urlExpirationDate: "google.protobuf.Timestamp",
    thumbnail: "_image"
  };
  var _searchFilesRequest = {};
  var _searchFilesResponse = { files: "_fileDescriptor" };
  var _updateFileDescriptorRequest = {
    fieldMask: "google.protobuf.FieldMask",
    file: "_fileDescriptor"
  };
  var _updateFileDescriptorResponse = { file: "_fileDescriptor" };
  ...
  function generateFilesDownloadUrl(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer2(_generateFilesDownloadUrlRequest, {});
    const { fromJSON: fromRes } = serializer2(_generateFilesDownloadUrlResponse, {});
  ...
  function generateFileDownloadUrl(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer2(_generateFileDownloadUrlRequest, {});
    const { fromJSON: fromRes } = serializer2(_generateFileDownloadUrlResponse, {});
  ...
  function getFileDescriptor(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer2(_getFileDescriptorRequest, {});
    const { fromJSON: fromRes } = serializer2(_getFileDescriptorResponse, {
      _archive,
      _audio,
      _audioV2,
      _document,
  ...
  function getFileDescriptors(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer2(_getFileDescriptorsRequest, {});
    const { fromJSON: fromRes } = serializer2(_getFileDescriptorsResponse, {
      _archive,
      _audio,
      _audioV2,
      _document,
  ...
  function updateFileDescriptor(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer2(_updateFileDescriptorRequest, {
      _archive,
      _audio,
      _audioV2,
      _document,
    ...
    const { fromJSON: fromRes } = serializer2(_updateFileDescriptorResponse, {
      _archive,
      _audio,
      _audioV2,
      _document,
  ...
  function generateFileUploadUrl(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer2(_generateFileUploadUrlRequest, {});
    const { fromJSON: fromRes } = serializer2(_generateFileUploadUrlResponse, {});
  ...
  function generateFileResumableUploadUrl(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer2(_generateFileResumableUploadUrlRequest, {});
    const { fromJSON: fromRes } = serializer2(_generateFileResumableUploadUrlResponse, {});
  ...
  function importFile(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer2(_importFileRequest, {});
    const { fromJSON: fromRes } = serializer2(_importFileResponse, {
      _archive,
      _audio,
      _audioV2,
      _document,
  ...
  function bulkImportFiles(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer2(_bulkImportFilesRequest, { _importFileRequest });
    const { fromJSON: fromRes } = serializer2(_bulkImportFilesResponse, {
      _archive,
      _audio,
      _audioV2,
      _document,
  ...
  function listFiles(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer2(_listFilesRequest, {});
    const { fromJSON: fromRes } = serializer2(_listFilesResponse, {
      _archive,
      _audio,
      _audioV2,
      _document,
  ...
  function searchFiles(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer2(_searchFilesRequest, {});
    const { fromJSON: fromRes } = serializer2(_searchFilesResponse, {
      _archive,
      _audio,
      _audioV2,
      _document,
  ...
  function generateVideoStreamingUrl(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer2(_generateVideoStreamingUrlRequest, {});
    const { fromJSON: fromRes } = serializer2(_generateVideoStreamingUrlResponse, {});
  ...
  function bulkDeleteFiles(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer2(_bulkDeleteFilesRequest, {});
    const { fromJSON: fromRes } = serializer2(_bulkDeleteFilesResponse, {});
  ...
  function bulkRestoreFilesFromTrashBin(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer2(_bulkRestoreFilesFromTrashBinRequest, {});
    const { fromJSON: fromRes } = serializer2(_bulkRestoreFilesFromTrashBinResponse, {});
  ...
  function listDeletedFiles(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer2(_listDeletedFilesRequest, {});
    const { fromJSON: fromRes } = serializer2(_listDeletedFilesResponse, {
      _archive,
      _audio,
      _audioV2,
      _document,
  ...
  // node_modules/@wix/media/build/es/src/media-site-media-v1-file-descriptor.universal.js
  ...
  var __verbose6 = false;
  function __log6(...args) {
    __verbose6 && console.log(...args);
  }
  function __inspect6(obj) {
    return obj;
  }
  var _toVeloEntity6 = "$";
  var _fromVeloEntity6 = "$";
  var MediaType;
  (function(MediaType2) {
  ...
  (function(State3) {
    State3["OK"] = "OK";
    State3["DELETED"] = "DELETED";
  })(State2 || (State2 = {}));
  var UploadProtocol;
  (function(UploadProtocol2) {
  ...
  var RootFolder;
  (function(RootFolder2) {
    RootFolder2["MEDIA_ROOT"] = "MEDIA_ROOT";
    RootFolder2["TRASH_ROOT"] = "TRASH_ROOT";
    RootFolder2["VISITOR_UPLOADS_ROOT"] = "VISITOR_UPLOADS_ROOT";
  })(RootFolder || (RootFolder = {}));
  var StreamFormat;
  (function(StreamFormat2) {
    StreamFormat2["UNKNOWN"] = "UNKNOWN";
    StreamFormat2["HLS"] = "HLS";
    StreamFormat2["DASH"] = "DASH";
  })(StreamFormat || (StreamFormat = {}));
  var _audioV22 = { assets: "wix.common.Audio" };
  var _bulkDeleteFilesRequest2 = {};
  var _bulkDeleteFilesResponse2 = {};
  var _bulkImportFilesRequest2 = { importFileRequests: "_importFileRequest" };
  var _bulkImportFilesResponse2 = { files: "_fileDescriptor" };
  var _bulkRestoreFilesFromTrashBinRequest2 = {};
  var _bulkRestoreFilesFromTrashBinResponse2 = {};
  var _fileDescriptor2 = { media: "_fileMedia" };
  var _fileMedia2 = {
  ...
  var _generateFileDownloadUrlRequest2 = {};
  var _generateFileDownloadUrlResponse2 = {};
  var _generateFileResumableUploadUrlRequest2 = {};
  var _generateFileResumableUploadUrlResponse2 = {};
  var _generateFilesDownloadUrlRequest2 = {};
  var _generateFilesDownloadUrlResponse2 = {};
  var _generateFileUploadUrlRequest2 = {};
  var _generateFileUploadUrlResponse2 = {};
  var _generateVideoStreamingUrlRequest2 = {};
  var _generateVideoStreamingUrlResponse2 = {};
  var _getFileDescriptorRequest2 = {};
  var _getFileDescriptorResponse2 = { file: "_fileDescriptor" };
  var _getFileDescriptorsRequest2 = {};
  var _getFileDescriptorsResponse2 = { files: "_fileDescriptor" };
  var _imageMedia2 = {
    image: "wix.common.Image",
    previewImage: "wix.common.Image"
  };
  var _importFileRequest2 = {};
  var _importFileResponse2 = { file: "_fileDescriptor" };
  var _listDeletedFilesRequest2 = {};
  var _listDeletedFilesResponse2 = { files: "_fileDescriptor" };
  var _listFilesRequest2 = {};
  var _listFilesResponse2 = { files: "_fileDescriptor" };
  var _model3D2 = { thumbnail: "wix.common.Image" };
  var _searchFilesRequest2 = {};
  var _searchFilesResponse2 = { files: "_fileDescriptor" };
  var _updateFileDescriptorRequest2 = { file: "_fileDescriptor" };
  var _updateFileDescriptorResponse2 = { file: "_fileDescriptor" };
  function generateFilesDownloadUrl2(fileIds) {
    var _a14, _b, _c;
    return __awaiter7(this, arguments, void 0, function* () {
      const requestTransformation = { fileIds: "$[0]" };
      const responseTransformation = "$";
      const { httpClient, sideEffects } = arguments[1];
      const { toAmbassadorRequest } = serializer({
        rootSchema: _generateFilesDownloadUrlRequest2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _fromVeloEntity6
        },
        customTransformation: requestTransformation
      });
      const { fromJSON } = serializer({
        rootSchema: _generateFilesDownloadUrlResponse2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _toVeloEntity6
        },
        customTransformation: responseTransformation
      });
      const payload = toAmbassadorRequest([fileIds]);
      const reqOpts = generateFilesDownloadUrl(payload);
      __log6(`"GenerateFilesDownloadUrl" sending request with: ${__inspect6(reqOpts)}`);
      (_a14 = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSiteCall) === null || _a14 === void 0 ? void 0 : _a14.call(sideEffects);
      try {
        const result = yield httpClient.request(reqOpts);
        (_b = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSuccess) === null || _b === void 0 ? void 0 : _b.call(sideEffects, result);
  ...
  function generateFileDownloadUrl2(fileId, options) {
    var _a14, _b, _c;
    return __awaiter7(this, arguments, void 0, function* () {
      const requestTransformation = {
        fileId: "$[0]",
      ...
      const { httpClient, sideEffects } = arguments[2];
      const { toAmbassadorRequest } = serializer({
        rootSchema: _generateFileDownloadUrlRequest2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _fromVeloEntity6
      ...
      const { fromJSON } = serializer({
        rootSchema: _generateFileDownloadUrlResponse2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _toVeloEntity6
      ...
      const reqOpts = generateFileDownloadUrl(payload);
      __log6(`"GenerateFileDownloadUrl" sending request with: ${__inspect6(reqOpts)}`);
      (_a14 = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSiteCall) === null || _a14 === void 0 ? void 0 : _a14.call(sideEffects);
      try {
        const result = yield httpClient.request(reqOpts);
        (_b = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSuccess) === null || _b === void 0 ? void 0 : _b.call(sideEffects, result);
  ...
  function getFileDescriptor2(fileId) {
    var _a14, _b, _c;
    return __awaiter7(this, arguments, void 0, function* () {
      ...
      const { httpClient, sideEffects } = arguments[1];
      const { toAmbassadorRequest } = serializer({
        rootSchema: _getFileDescriptorRequest2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _fromVeloEntity6
      ...
      const { fromJSON } = serializer({
        rootSchema: _getFileDescriptorResponse2,
        depSchemas: {
          _audioV2: _audioV22,
          _fileDescriptor: _fileDescriptor2,
          _fileMedia: _fileMedia2,
          _imageMedia: _imageMedia2,
          _model3D: _model3D2
        },
        fqdnTransformation: {
          paths: [...["file"]],
      ...
      __log6(`"GetFileDescriptor" sending request with: ${__inspect6(reqOpts)}`);
      (_a14 = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSiteCall) === null || _a14 === void 0 ? void 0 : _a14.call(sideEffects);
      try {
        const result = yield httpClient.request(reqOpts);
        (_b = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSuccess) === null || _b === void 0 ? void 0 : _b.call(sideEffects, result);
  ...
  function getFileDescriptors2(fileIds) {
    var _a14, _b, _c;
    return __awaiter7(this, arguments, void 0, function* () {
      const requestTransformation = { fileIds: "$[0]" };
      const responseTransformation = "$";
      const { httpClient, sideEffects } = arguments[1];
      const { toAmbassadorRequest } = serializer({
        rootSchema: _getFileDescriptorsRequest2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _fromVeloEntity6
      ...
      const { fromJSON } = serializer({
        rootSchema: _getFileDescriptorsResponse2,
        depSchemas: {
          _audioV2: _audioV22,
          _fileDescriptor: _fileDescriptor2,
          _fileMedia: _fileMedia2,
      ...
      __log6(`"GetFileDescriptors" sending request with: ${__inspect6(reqOpts)}`);
      (_a14 = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSiteCall) === null || _a14 === void 0 ? void 0 : _a14.call(sideEffects);
      try {
        const result = yield httpClient.request(reqOpts);
        (_b = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSuccess) === null || _b === void 0 ? void 0 : _b.call(sideEffects, result);
  ...
  function updateFileDescriptor2(_id, file) {
    var _a14, _b, _c;
    return __awaiter7(this, arguments, void 0, function* () {
      ...
      const { httpClient, sideEffects } = arguments[2];
      const { toAmbassadorRequest } = serializer({
        rootSchema: _updateFileDescriptorRequest2,
        depSchemas: {
          _audioV2: _audioV22,
          _fileDescriptor: _fileDescriptor2,
          _fileMedia: _fileMedia2,
      ...
      const { fromJSON } = serializer({
        rootSchema: _updateFileDescriptorResponse2,
        depSchemas: {
          _audioV2: _audioV22,
          _fileDescriptor: _fileDescriptor2,
          _fileMedia: _fileMedia2,
      ...
      __log6(`"UpdateFileDescriptor" sending request with: ${__inspect6(reqOpts)}`);
      (_a14 = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSiteCall) === null || _a14 === void 0 ? void 0 : _a14.call(sideEffects);
      try {
        const result = yield httpClient.request(reqOpts);
        (_b = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSuccess) === null || _b === void 0 ? void 0 : _b.call(sideEffects, result);
  ...
  function generateFileUploadUrl2(mimeType, options) {
    var _a14, _b, _c;
    return __awaiter7(this, arguments, void 0, function* () {
      const requestTransformation = {
        mimeType: "$[0]",
      ...
      const { httpClient, sideEffects } = arguments[2];
      const { toAmbassadorRequest } = serializer({
        rootSchema: _generateFileUploadUrlRequest2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _fromVeloEntity6
      ...
      const { fromJSON } = serializer({
        rootSchema: _generateFileUploadUrlResponse2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _toVeloEntity6
      ...
      __log6(`"GenerateFileUploadUrl" sending request with: ${__inspect6(reqOpts)}`);
      (_a14 = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSiteCall) === null || _a14 === void 0 ? void 0 : _a14.call(sideEffects);
      try {
        const result = yield httpClient.request(reqOpts);
        (_b = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSuccess) === null || _b === void 0 ? void 0 : _b.call(sideEffects, result);
  ...
  function generateFileResumableUploadUrl2(mimeType, options) {
    var _a14, _b, _c;
    return __awaiter7(this, arguments, void 0, function* () {
      const requestTransformation = {
        mimeType: "$[0]",
      ...
      const { httpClient, sideEffects } = arguments[2];
      const { toAmbassadorRequest } = serializer({
        rootSchema: _generateFileResumableUploadUrlRequest2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _fromVeloEntity6
      ...
      const { fromJSON } = serializer({
        rootSchema: _generateFileResumableUploadUrlResponse2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _toVeloEntity6
      ...
      const payload = toAmbassadorRequest([mimeType, options]);
      const reqOpts = generateFileResumableUploadUrl(payload);
      __log6(`"GenerateFileResumableUploadUrl" sending request with: ${__inspect6(reqOpts)}`);
      (_a14 = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSiteCall) === null || _a14 === void 0 ? void 0 : _a14.call(sideEffects);
      try {
        const result = yield httpClient.request(reqOpts);
        (_b = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSuccess) === null || _b === void 0 ? void 0 : _b.call(sideEffects, result);
  ...
  function importFile2(url, options) {
    var _a14, _b, _c;
    return __awaiter7(this, arguments, void 0, function* () {
      const requestTransformation = {
        url: "$[0]",
      ...
      const { httpClient, sideEffects } = arguments[2];
      const { toAmbassadorRequest } = serializer({
        rootSchema: _importFileRequest2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _fromVeloEntity6
      ...
      const { fromJSON } = serializer({
        rootSchema: _importFileResponse2,
        depSchemas: {
          _audioV2: _audioV22,
          _fileDescriptor: _fileDescriptor2,
          _fileMedia: _fileMedia2,
      ...
      __log6(`"ImportFile" sending request with: ${__inspect6(reqOpts)}`);
      (_a14 = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSiteCall) === null || _a14 === void 0 ? void 0 : _a14.call(sideEffects);
      try {
        const result = yield httpClient.request(reqOpts);
        (_b = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSuccess) === null || _b === void 0 ? void 0 : _b.call(sideEffects, result);
  ...
  function bulkImportFiles2(importFileRequests) {
    var _a14, _b, _c;
    return __awaiter7(this, arguments, void 0, function* () {
      ...
      const { httpClient, sideEffects } = arguments[1];
      const { toAmbassadorRequest } = serializer({
        rootSchema: _bulkImportFilesRequest2,
        depSchemas: { _importFileRequest: _importFileRequest2 },
        fqdnTransformation: {
          paths: [],
          transformation: _fromVeloEntity6
        },
      ...
      const { fromJSON } = serializer({
        rootSchema: _bulkImportFilesResponse2,
        depSchemas: {
          _audioV2: _audioV22,
          _fileDescriptor: _fileDescriptor2,
          _fileMedia: _fileMedia2,
      ...
      __log6(`"BulkImportFiles" sending request with: ${__inspect6(reqOpts)}`);
      (_a14 = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSiteCall) === null || _a14 === void 0 ? void 0 : _a14.call(sideEffects);
      try {
        const result = yield httpClient.request(reqOpts);
        (_b = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSuccess) === null || _b === void 0 ? void 0 : _b.call(sideEffects, result);
  ...
  function listFiles2(options) {
    ...
    return __awaiter7(this, arguments, void 0, function* () {
      ...
      const { fromJSON } = serializer({
        rootSchema: _listFilesResponse2,
        depSchemas: {
          _audioV2: _audioV22,
          _fileDescriptor: _fileDescriptor2,
          _fileMedia: _fileMedia2,
      ...
      __log6(`"ListFiles" sending request with: ${__inspect6(reqOpts)}`);
      (_a14 = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSiteCall) === null || _a14 === void 0 ? void 0 : _a14.call(sideEffects);
      try {
        const result = yield httpClient.request(reqOpts);
        (_b = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSuccess) === null || _b === void 0 ? void 0 : _b.call(sideEffects, result);
  ...
  function searchFiles2(options) {
    ...
    return __awaiter7(this, arguments, void 0, function* () {
      ...
      const { httpClient, sideEffects } = arguments[1];
      const { toAmbassadorRequest } = serializer({
        rootSchema: _searchFilesRequest2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _fromVeloEntity6
      ...
      const { fromJSON } = serializer({
        rootSchema: _searchFilesResponse2,
        depSchemas: {
          _audioV2: _audioV22,
          _fileDescriptor: _fileDescriptor2,
          _fileMedia: _fileMedia2,
      ...
      __log6(`"SearchFiles" sending request with: ${__inspect6(reqOpts)}`);
      (_a14 = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSiteCall) === null || _a14 === void 0 ? void 0 : _a14.call(sideEffects);
      try {
        const result = yield httpClient.request(reqOpts);
        (_b = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSuccess) === null || _b === void 0 ? void 0 : _b.call(sideEffects, result);
  ...
  function generateVideoStreamingUrl2(fileId, options) {
    var _a14, _b, _c;
    return __awaiter7(this, arguments, void 0, function* () {
      ...
      const { httpClient, sideEffects } = arguments[2];
      const { toAmbassadorRequest } = serializer({
        rootSchema: _generateVideoStreamingUrlRequest2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _fromVeloEntity6
      ...
      const { fromJSON } = serializer({
        rootSchema: _generateVideoStreamingUrlResponse2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _toVeloEntity6
      ...
      const payload = toAmbassadorRequest([fileId, options]);
      const reqOpts = generateVideoStreamingUrl(payload);
      __log6(`"GenerateVideoStreamingUrl" sending request with: ${__inspect6(reqOpts)}`);
      (_a14 = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSiteCall) === null || _a14 === void 0 ? void 0 : _a14.call(sideEffects);
      try {
        const result = yield httpClient.request(reqOpts);
        (_b = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSuccess) === null || _b === void 0 ? void 0 : _b.call(sideEffects, result);
  ...
  function bulkDeleteFiles2(fileIds, options) {
    var _a14, _b, _c;
    return __awaiter7(this, arguments, void 0, function* () {
      const requestTransformation = {
        fileIds: "$[0]",
      ...
      const { httpClient, sideEffects } = arguments[2];
      const { toAmbassadorRequest } = serializer({
        rootSchema: _bulkDeleteFilesRequest2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _fromVeloEntity6
      ...
      const { fromJSON } = serializer({
        rootSchema: _bulkDeleteFilesResponse2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _toVeloEntity6
      ...
      __log6(`"BulkDeleteFiles" sending request with: ${__inspect6(reqOpts)}`);
      (_a14 = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSiteCall) === null || _a14 === void 0 ? void 0 : _a14.call(sideEffects);
      try {
        const result = yield httpClient.request(reqOpts);
        (_b = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSuccess) === null || _b === void 0 ? void 0 : _b.call(sideEffects, result);
  ...
  function bulkRestoreFilesFromTrashBin2(fileIds) {
    var _a14, _b, _c;
    return __awaiter7(this, arguments, void 0, function* () {
      const requestTransformation = { fileIds: "$[0]" };
      const responseTransformation = "$";
      const { httpClient, sideEffects } = arguments[1];
      const { toAmbassadorRequest } = serializer({
        rootSchema: _bulkRestoreFilesFromTrashBinRequest2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _fromVeloEntity6
      ...
      const { fromJSON } = serializer({
        rootSchema: _bulkRestoreFilesFromTrashBinResponse2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _toVeloEntity6
      ...
      const payload = toAmbassadorRequest([fileIds]);
      const reqOpts = bulkRestoreFilesFromTrashBin(payload);
      __log6(`"BulkRestoreFilesFromTrashBin" sending request with: ${__inspect6(reqOpts)}`);
      (_a14 = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSiteCall) === null || _a14 === void 0 ? void 0 : _a14.call(sideEffects);
      try {
        const result = yield httpClient.request(reqOpts);
        (_b = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSuccess) === null || _b === void 0 ? void 0 : _b.call(sideEffects, result);
  ...
  function listDeletedFiles2(options) {
    var _a14, _b, _c;
    return __awaiter7(this, arguments, void 0, function* () {
      const requestTransformation = {
        parentFolderId: "$[0].parentFolderId",
      ...
      const { httpClient, sideEffects } = arguments[1];
      const { toAmbassadorRequest } = serializer({
        rootSchema: _listDeletedFilesRequest2,
        depSchemas: {},
        fqdnTransformation: {
          paths: [],
          transformation: _fromVeloEntity6
      ...
      const { fromJSON } = serializer({
        rootSchema: _listDeletedFilesResponse2,
        depSchemas: {
          _audioV2: _audioV22,
          _fileDescriptor: _fileDescriptor2,
          _fileMedia: _fileMedia2,
      ...
      __log6(`"ListDeletedFiles" sending request with: ${__inspect6(reqOpts)}`);
      (_a14 = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSiteCall) === null || _a14 === void 0 ? void 0 : _a14.call(sideEffects);
      try {
        const result = yield httpClient.request(reqOpts);
        (_b = sideEffects === null || sideEffects === void 0 ? void 0 : sideEffects.onSuccess) === null || _b === void 0 ? void 0 : _b.call(sideEffects, result);
  ...
  // node_modules/@wix/media/build/es/src/media-site-media-v1-file-descriptor.public.js
  var __metadata6 = { PACKAGE_NAME: "@wix/media" };
  ...
  function updateFileDescriptor3(httpClient) {
    return (_id, file) => updateFileDescriptor2(
      _id,
      file,
      // @ts-ignore
      { httpClient }
  ...
  var WixData = class {
    ...
    setClient() {
      this.wixClient = createClient({
        modules: { items: data_v2_data_item_public_exports, files: media_site_media_v1_file_descriptor_public_exports },
        auth: OAuthStrategy({
