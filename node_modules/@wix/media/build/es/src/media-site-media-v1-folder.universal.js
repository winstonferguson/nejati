...
import * as ambassadorWixMediaSiteMediaV1Folder from './media-site-media-v1-folder.http';
let __verbose = false;
function __log(...args) {
 ...
 */
export function createFolder(displayName, options) {
    var _a, _b, _c;
 ...
 * @applicableIdentity APP
 */
export function searchFolders(options) {
    var _a, _b, _c;
    return __awaiter(this, arguments, void 0, function* () {
        const requestTransformation = {
 ...
 */
export function updateFolder(_id, folder) {
    var _a, _b, _c;
    return __awaiter(this, arguments, void 0, function* () {
 ...
 * @applicableIdentity APP
 */
export function generateFolderDownloadUrl(folderId) {
    var _a, _b, _c;
    return __awaiter(this, arguments, void 0, function* () {
        const requestTransformation = { folderId: '$[0]' };
        const responseTransformation = '$';
 ...
 * @applicableIdentity APP
 */
export function bulkDeleteFolders(folderIds, options) {
    var _a, _b, _c;
    return __awaiter(this, arguments, void 0, function* () {
        const requestTransformation = {
            folderIds: '$[0]',
 ...
 * @applicableIdentity APP
 */
export function bulkRestoreFoldersFromTrashBin(folderIds) {
    var _a, _b, _c;
    return __awaiter(this, arguments, void 0, function* () {
 ...
 * @applicableIdentity APP
 */
export function listDeletedFolders(options) {
    var _a, _b, _c;
    return __awaiter(this, arguments, void 0, function* () {
        const requestTransformation = {
            parentFolderId: '$[0].parentFolderId',
