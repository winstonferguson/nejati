...
function createFolder(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = (0, ambassador_1.serializer)(_createFolderRequest, {});
    const { fromJSON: fromRes } = (0, ambassador_1.serializer)(_createFolderResponse, { _folder });
...
function getFolder(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = (0, ambassador_1.serializer)(_getFolderRequest, {});
    const { fromJSON: fromRes } = (0, ambassador_1.serializer)(_getFolderResponse, { _folder });
...
function listFolders(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = (0, ambassador_1.serializer)(_listFoldersRequest, {});
    const { fromJSON: fromRes } = (0, ambassador_1.serializer)(_listFoldersResponse, { _folder });
 ...
 */
function searchFolders(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = (0, ambassador_1.serializer)(_searchFoldersRequest, {});
    const { fromJSON: fromRes } = (0, ambassador_1.serializer)(_searchFoldersResponse, { _folder });
...
function updateFolder(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = (0, ambassador_1.serializer)(_updateFolderRequest, { _folder });
    const { fromJSON: fromRes } = (0, ambassador_1.serializer)(_updateFolderResponse, { _folder });
 ...
 */
function generateFolderDownloadUrl(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = (0, ambassador_1.serializer)(_generateFolderDownloadUrlRequest, {});
    const { fromJSON: fromRes } = (0, ambassador_1.serializer)(_generateFolderDownloadUrlResponse, {});
...
function bulkDeleteFolders(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = (0, ambassador_1.serializer)(_bulkDeleteFoldersRequest, {});
    const { fromJSON: fromRes } = (0, ambassador_1.serializer)(_bulkDeleteFoldersResponse, {});
...
function bulkRestoreFoldersFromTrashBin(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = (0, ambassador_1.serializer)(_bulkRestoreFoldersFromTrashBinRequest, {});
    const { fromJSON: fromRes } = (0, ambassador_1.serializer)(_bulkRestoreFoldersFromTrashBinResponse, {});
...
function listDeletedFolders(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = (0, ambassador_1.serializer)(_listDeletedFoldersRequest, {});
    const { fromJSON: fromRes } = (0, ambassador_1.serializer)(_listDeletedFoldersResponse, {
        _folder,
    });
