...
exports.getBlurValue = getBlurValue;
exports.getCSSOverrides = getCSSOverrides;
exports.getConvertedFitting = getConvertedFitting;
exports.getIsFakeTile = getIsFakeTile;
...
const ALIGN_TYPE_TO_POSITION = {
  [_imageServiceConstants.alignTypes.CENTER]: '50% 50%',
  [_imageServiceConstants.alignTypes.TOP_LEFT]: '0% 0%',
  [_imageServiceConstants.alignTypes.TOP_RIGHT]: '100% 0%',
  [_imageServiceConstants.alignTypes.TOP]: '50% 0%',
  [_imageServiceConstants.alignTypes.BOTTOM_LEFT]: '0% 100%',
  [_imageServiceConstants.alignTypes.BOTTOM_RIGHT]: '100% 100%',
  [_imageServiceConstants.alignTypes.BOTTOM]: '50% 100%',
  [_imageServiceConstants.alignTypes.RIGHT]: '100% 50%',
  [_imageServiceConstants.alignTypes.LEFT]: '0% 50%'
};
const POSITION_TO_ALIGN_TYPE = Object.entries(ALIGN_TYPE_TO_POSITION).reduce((acc, [align, position]) => {
  acc[position] = align;
  return acc;
}, {});
const TILE_FITTING_TYPES = [_imageServiceConstants.fittingTypes.TILE, _imageServiceConstants.fittingTypes.TILE_HORIZONTAL, _imageServiceConstants.fittingTypes.TILE_VERTICAL, _imageServiceConstants.fittingTypes.LEGACY_BG_FIT_AND_TILE, _imageServiceConstants.fittingTypes.LEGACY_BG_FIT_AND_TILE_HORIZONTAL, _imageServiceConstants.fittingTypes.LEGACY_BG_FIT_AND_TILE_VERTICAL];
...
function getIsFakeTile(fittingType, src, {
  ...
  return fittingType === _imageServiceConstants.fittingTypes.TILE && src.width > targetWidth && src.height > targetHeight;
}
/**
 *
...
function getConvertedFitting(fittingType, isFakeTile) {
  ...
  const isFill = fittingType === _imageServiceConstants.fittingTypes.SCALE_TO_FILL;
  return isFill || isTile ? _imageServiceConstants.fittingTypes.SCALE_TO_FIT : fittingType;
}
...
function getCSSOverrides(fittingType, src, target, alignment = 'center') {
  ...
  } else if ([_imageServiceConstants.fittingTypes.LEGACY_ORIGINAL_SIZE, _imageServiceConstants.fittingTypes.ORIGINAL_SIZE].includes(fittingType)) {
    returnValue.img = {
      objectFit: 'none',
      top: 'auto',
      left: 'auto',
