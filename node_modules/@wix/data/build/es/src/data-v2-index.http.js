...
export function createIndex(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer(_createIndexRequest, {});
    const { fromJSON: fromRes } = serializer(_createIndexResponse, {});
...
export function dropIndex(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer(_dropIndexRequest, {});
    const { fromJSON: fromRes } = serializer(_dropIndexResponse, {});
...
export function listIndexes(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer(_listIndexesRequest, {});
    const { fromJSON: fromRes } = serializer(_listIndexesResponse, {});
