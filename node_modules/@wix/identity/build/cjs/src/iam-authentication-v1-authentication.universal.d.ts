...
export interface LoginWithIdpConnectionTokensRequest {
    /** The id of the connection id (can be fetched by calling connection-service.listEnabledConnectionsClientData */
    idpConnectionId?: string;
...
export interface ChangePasswordRequestNonNullableFields {
    newPassword: string;
}
 ...
 */
export declare function changePassword(newPassword: string): Promise<ChangePasswordRequest & ChangePasswordRequestNonNullableFields>;
/** @public
 * @documentationMaturity preview
 */
export declare function loginWithIdpConnectionTokens(options?: LoginWithIdpConnectionTokensOptions): Promise<StateMachineResponse & StateMachineResponseNonNullableFields>;
export interface LoginWithIdpConnectionTokensOptions {
    /** The id of the connection id (can be fetched by calling connection-service.listEnabledConnectionsClientData */
    idpConnectionId?: string;
    /** A set of fields that are required for the connection to be able to identify and authenticate the user */
    params?: Record<string, string>;
