...
export function changePassword(payload) {
    ...
    const { fromJSON: fromRes } = serializer(_changePasswordRequest, {});
...
export function loginWithIdpConnectionTokens(payload) {
    const { toJSON: toReq, fromJSON: fromReq } = serializer(_loginWithIdpConnectionTokensRequest, {});
    const { fromJSON: fromRes } = serializer(_stateMachineResponse, {
        _commonCustomValue,
        _commonListValue,
        _commonMapValue,
